...
print("Welcome to Serververs Showdown. The game has been hacked. The players are missing, and it's up to you to assemble the ultimate team and reclailm the court. Ready to play for a chance at freedom?"
...
# We have to ask the user if they want to play or not so we will have an If statement if they choose yes the game keeps explaining if they choose no it returns false and kicks them out
