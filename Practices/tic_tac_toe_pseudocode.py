...
# For loop a list ot make the tic tac toe board
# def print_board(board)
    #[1,2,3]
    #[4,5,6]
    #[7,8,9]
    # print the board choices so the user can choose where to put their first mark
# The player can only input an x so there has to be an if True statement to check what they are inputing
    # If the input is invalid tell the user to "try again!"
    # print the board and the choices on where to put the X.
# use random.randint to choose the choice of the computer on where to put the O on the board
